...
function App() {
  ...
  const handleLayer2 = (event: any) => {
    const x0 = 17 + event.clientX / 650;

    const y0 = 17 - event.clientY / 650;

    layer2[0].current.style.right = x0 + "rem";
  ...
  const handleLayer4 = (event: any) => {
    const x0 = 20 + event.clientX / 4200;
    const x1 = 24 + event.clientX / 4200;
    const x2 = 2 + event.clientX / 4200;

    const y0 = -6 - event.clientY / 4200;
    const y1 = 2 - event.clientY / 4200;
    const y2 = -5 - event.clientY / 4200;
  ...
  return (
    <div className="main-container" onMouseMove={handleMove}>
